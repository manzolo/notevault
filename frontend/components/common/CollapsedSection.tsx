...
export default function CollapsedSection({ icon, label, onAdd, addLabel, onAdd2, addLabel2 }: Props) {
  return (
    <div className="flex items-center gap-3 px-4 py-2.5 rounded-xl border border-dashed border-gray-200 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-800/20 hover:border-gray-300 dark:hover:border-gray-600 transition-colors group flex-wrap">
